...
{
    public class UpdateVaultNameUseCase
    {
        private readonly IVaultRepository _vaultRepository;

        public UpdateVaultNameUseCase(IVaultRepository vaultRepository)
        {
            _vaultRepository = vaultRepository;
        }

        public async Task<GetVaultResponse> ExecuteAsync(Guid vaultId, Guid userId, string newName)
        {
